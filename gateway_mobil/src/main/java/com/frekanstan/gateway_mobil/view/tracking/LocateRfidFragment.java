...
import com.frekanstan.gateway_mobil.databinding.LocateRfidFragmentBinding;
...
public class LocateRfidFragment extends Fragment implements ISearchableFragment, ICanScanCode, ICanScanRange {
    ...
    public void onCodeScanned(String code) {
        ...
        if (asset == null)
            context.runOnUiThread(() -> Toast.makeText(context, R.string.foreign_asset_qrcode_read, Toast.LENGTH_SHORT).show());
        else
