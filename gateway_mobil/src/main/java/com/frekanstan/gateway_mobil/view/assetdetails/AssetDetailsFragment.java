...
import com.frekanstan.gateway_mobil.data.Brand_;
import com.frekanstan.gateway_mobil.data.ImageToUpload;
import com.frekanstan.gateway_mobil.data.ImageToUpload_;
import com.frekanstan.gateway_mobil.data.Model;
import com.frekanstan.gateway_mobil.data.Model_;
import com.frekanstan.gateway_mobil.databinding.AssetDetailsFragmentBinding;
    ...
    public void onClick(View v) {
        ...
        if (v.getId() == R.id.serialNoB) {
            ...
            if (v.getId() == R.id.brandB) {
                val ddAdapter = new ArrayAdapter<Brand>(
                        context,
