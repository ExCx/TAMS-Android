...
import com.frekanstan.gateway_mobil.app.assets.BrandDAO;
import com.frekanstan.gateway_mobil.app.assets.ModelDAO;
...
import com.frekanstan.gateway_mobil.data.Brand;
import com.frekanstan.gateway_mobil.data.Budget;
        ...
        if (opId > lastOpId)
            ...
            request.setResponseListener(response -> {
                if (response.getSuccess()) {
                    if (op.countedAssets.size() != response.getResult().size()) {
