...
public class CountingOp extends EntityBase implements ICountingOp {
    ...
    public CountingOp(long id, String title, long globalId, long personCreatedId, long personTaskedId, Date creationTime, Date deadline, Date timeStarted, Date timeFinished, long relatedTypeId, long relatedLocationId, long relatedPersonId, Boolean isConfirmed, Boolean isDeleted, long tenantId) {
        this.id = id;
        this.title = title;
        this.globalId = id;
