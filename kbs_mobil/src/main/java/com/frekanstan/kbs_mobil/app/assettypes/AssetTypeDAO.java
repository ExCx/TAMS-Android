package com.frekanstan.kbs_mobil.app.assettypes;
...
import com.frekanstan.kbs_mobil.data.AssetType_;
...
public class AssetTypeDAO extends DAO<AssetType>
{
    ...
    public IAssetType findTypeOfDepth(AssetType lowestType, int depth) {
