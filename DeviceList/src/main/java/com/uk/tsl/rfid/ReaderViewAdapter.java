...
public class ReaderViewAdapter extends RecyclerView.Adapter<ReaderViewAdapter.ReaderViewHolder>
{
    ...
    class ReaderViewHolder extends RecyclerView.ViewHolder
    {
        ...
        void bind(Reader reader, boolean isSelected)
        {
            ...
            usbTV.setTextColor(isUsbActive ? ContextCompat.getColor(mContext, R.color.dl_transport_on) : ContextCompat.getColor(mContext, R.color.dl_transport_off));

            TextView btTV = mBtTextView;
            btTV.setVisibility(isBtPresent ? View.VISIBLE : View.INVISIBLE);
            btTV.setTextColor(isBtActive ? ContextCompat.getColor(mContext, R.color.dl_transport_on) : ContextCompat.getColor(mContext, R.color.dl_transport_off));

            itemView.setBackgroundColor(isSelected ? ContextCompat.getColor(mContext, R.color.dl_row_selected) : ContextCompat.getColor(mContext, R.color.dl_row_normal));
        }
    }
