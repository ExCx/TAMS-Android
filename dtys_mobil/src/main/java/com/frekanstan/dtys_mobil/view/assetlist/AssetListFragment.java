...
import com.frekanstan.dtys_mobil.databinding.AssetListFragmentBinding;
...
public class AssetListFragment extends Fragment implements ISearchableListFragment {
    ...
    public boolean onOptionsItemSelected(@NonNull MenuItem item) {
        ...
        if (itemId == R.id.add_filter_tag_no) {
            filterManager.showFilterTagNoDialog();
            return true;
        } else if (itemId == R.id.add_filter_is_labeled) {
            ...
            adapter.getSelectableList().selectAll(listType, locationId, personId, assetTypeId);
            return true;
        }
